...
- [x] WF-007 ToDo/maintenance hygiene: corrected WF-005 commit tag and added `docs/dev/MAINTENANCE.md` guidance for updating `(commit: pending|TBD)` to exact commit hashes when closing WF items. (commit: pending)
