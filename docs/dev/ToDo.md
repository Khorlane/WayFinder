...
- [x] WF-004 Refactor package/folder layout to architecture-aligned top-level subsystems (`wcs/`, `wne/`, `wmr/`, `solver/`) and remove temporary `internal/harness` naming. (commit: pending)
